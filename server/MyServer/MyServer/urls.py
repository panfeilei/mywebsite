...
urlpatterns = [
    ...
    url(r'^login/', test_view.loginView, name='login'),
    url(r'^vertify', test_view.verify, name='verify'),
    ...
    url(r'download', test_view.download),
    ...
    url(r'verifytcode', test_view.create_code_img),
